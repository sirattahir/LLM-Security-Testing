...
This attack type is classified as **OWASP LLM01** — the number one LLM security risk according to the Open Worldwide Application Security Project.

## Key Findings

### Near-Perfect Security
GPT-OSS-Safeguard-20b achieved a **99% pass rate** — the highest score across all 5 models tested in this study. Out of 512 attack attempts, only approximately 5 succeeded. This is an exceptional result that no general-purpose model came close to matching.
